...
function DyDt = NuRegTcellmodel_withdepletion(t, Y, params, timing, frac)
...
dELdt = m*(lambdaEL*AL)/(1 + r1*RL) + omegaEL*(1 - (EL + RL)/C)*EL - phiE*EL- deltaE*EL;
dRLdt =  m*lambdaR*AL + (omegaR)*(1 - (EL + RL)/C)*RL - phiR*RL - deltaR*RL;
