...
figurename = 'timetodiseasevsdeltaA_ToyModel2_ND.pdf';
...
'hi'
figure(1)
plot(deltaA_vals, time./omegaR, 'Color', 'k', 'LineWidth', 1.5, 'LineStyle', '-')
hold on
...
figure(1)
plot(deltaA_vals, time./omegaR, 'Color', 'r', 'LineWidth', 1.5, 'LineStyle', '--')
hold on
% xline(0.01)
ax = gca;
ax.FontSize = 21;
