...
legend('R_L(0) = 10, dose = 0', 'R_L(0) = 10, dose = 1e10 @ 1 year', ['R_L(0) = 10, dose = 1e10 @ 1 year, APC depletion timing = ', num2str(timing/365)], 'Location', 'best')
