...
% Dosing Information
N = 2;
Dose_vals = [1e10 1e12 1e14];%[0, 1e2, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10];
Dose_Time_vals = 1*365:0.5*365:20*365;
...
% Figure Name
figurename = ['Figures/timetodisease_latedisease_RLinitconds_samer1andr2_nuis', num2str(nu), '.pdf'];
